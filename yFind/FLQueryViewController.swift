...
//        (navigationItem.rightBarButtonItem as! SourceCodeBarButtonItem).filenames = ["FLQueryViewController"]
        ...
        let statesFeatureTableURL = URL(string: "https://services.arcgis.com/FvF9MZKp3JWPrSkg/arcgis/rest/services/Floorplans_V/FeatureServer/0")!
    ...
    func selectFeaturesForSearchTerm(_ searchTerm: String) {
        ...
        queryParams.whereClause = "Bldg_Abv LIKE '%\(searchTerm)%'"
